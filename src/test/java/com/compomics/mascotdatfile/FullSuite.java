...
public class FullSuite extends TestCase {
    ...
    public static Test suite() {
        ...
        ts.addTest(new TestSuite(com.compomics.mascotdatfile.util.mascot.TestHeader.class));
        ts.addTest(new TestSuite(com.compomics.mascotdatfile.util.mascot.TestMascotDatfile.class));
        ts.addTest(new TestSuite(com.compomics.mascotdatfile.util.mascot.TestMasses.class));
        ts.addTest(new TestSuite(com.compomics.mascotdatfile.util.mascot.TestModification.class));
        ts.addTest(new TestSuite(com.compomics.mascotdatfile.util.mascot.TestModificationConversion.class));
        ts.addTest(new TestSuite(com.compomics.mascotdatfile.util.mascot.TestParameters.class));
        ts.addTest(new TestSuite(com.compomics.mascotdatfile.util.mascot.TestPeptideHit.class));
        ts.addTest(new TestSuite(com.compomics.mascotdatfile.util.mascot.TestPeptideHitAnnotation.class));
        ts.addTest(new TestSuite(com.compomics.mascotdatfile.util.mascot.TestPeptideToQueryMap.class));
        ts.addTest(new TestSuite(com.compomics.mascotdatfile.util.mascot.TestProteinHit.class));
        ts.addTest(new TestSuite(com.compomics.mascotdatfile.util.mascot.TestProteinID.class));
        ts.addTest(new TestSuite(com.compomics.mascotdatfile.util.mascot.TestProteinMap.class));
        ts.addTest(new TestSuite(com.compomics.mascotdatfile.util.mascot.TestQuery.class));
        ts.addTest(new TestSuite(com.compomics.mascotdatfile.util.mascot.TestQueryToPeptideMap.class));
        ts.addTest(new TestSuite(com.compomics.mascotdatfile.util.mascot.TestThreshold.class));

        ts.addTest(new TestSuite(com.compomics.mascotdatfile.util.mascot.TestQuantitation.class));

        ts.addTest(new TestSuite(com.compomics.mascotdatfile.util.mascot.parser.TestMascotRawParser.class));
        ts.addTest(new TestSuite(com.compomics.mascotdatfile.util.mascot.TestFactory.class));
        ...
        ts.addTest(new TestSuite(com.compomics.mascotdatfile.util.mascot.index.TestDecoyPeptideToQueryMap.class));
        ts.addTest(new TestSuite(com.compomics.mascotdatfile.util.mascot.index.TestQuantitation.class));

        ts.addTest(new TestSuite(com.compomics.mascotdatfile.util.mascot.index.TestController.class));
